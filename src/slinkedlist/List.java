...
/**
 * 자바 List Interface
 * List는 ArrayList, SinglyLinkedList, DoublyLinked에 의해 각각 구현됨
 *
 * @author st_lab
...
public interface List<E> {
     ...
     * @return 리스트에서 중복을 허용하지 않을 경우에 리스트에 이미 중복되는 요소가 있을 경우
    ...
    /**
     * 리스트의 index 위치에 있는 요소를 삭제합닌다
     *
     * @param index 리스트에서 삭제할 위치 변ㄴ수
     * @return 삭제된 요소를 반환
     */
    E remove(int index);
     ...
     * @return 리스트에 삭제할 요솩 없거나 삭제에 실패할 경우
